...
const musicManager: MusicManager = {
    ...
    soundtracks: [
        { area: "menu", soundtrack: setup.menuMusic },
        { area: "mall", soundtrack: setup.mallMusic },
        { area: "discoMusic", soundtrack: setup.discoMusic },
        { area: "bedroom", soundtrack: setup.bedroomMusic },
        { area: "alternateMusic", soundtrack: setup.alternateMusic },
        { area: "dangersMusic", soundtrack: setup.dangersMusic },
        { area: "heaven", soundtrack: setup.heavenMusic },
        { area: "death", soundtrack: setup.deathMusic },
        { area: "postdeathMusic", soundtrack: setup.postdeathMusic },
        { area: "endMusic", soundtrack: setup.surgeryMusic },
    ],
    soundEffects: [
    ],
