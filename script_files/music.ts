...
const musicManager: MusicManager = {
    ...
    soundtracks: [
        ...
        { area: "mallMusic", soundtrack: setup.mallMusic },
        { area: "bedroomMusic", soundtrack: setup.bedroomMusic },
        { area: "deathMusic", soundtrack: setup.deathMusic },
        { area: "heavenMusic", soundtrack: setup.heavenMusic },
    ],
    soundEffects: [
    ],
